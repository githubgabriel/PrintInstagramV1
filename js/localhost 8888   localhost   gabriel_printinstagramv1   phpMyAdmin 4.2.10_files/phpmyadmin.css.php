...
.ic_b_sbrowse { background-position: 0 -720px !important; width: 10px; height: 10px; }
.ic_b_search { background-position: 0 -736px !important; }
.ic_b_selboard { background-position: 0 -752px !important; }
.ic_b_select { background-position: 0 -768px !important; }
.ic_b_snewtbl { background-position: 0 -784px !important; width: 10px; height: 10px; }
.ic_b_spatial { background-position: 0 -800px !important; }
.ic_b_sql { background-position: 0 -816px !important; }
.ic_b_sqlhelp { background-position: 0 -832px !important; }
.ic_b_table_add { background-position: 0 -848px !important; }
.ic_b_tblanalyse { background-position: 0 -864px !important; }
.ic_b_tblexport { background-position: 0 -880px !important; }
.ic_b_tblimport { background-position: 0 -896px !important; }
.ic_b_tblops { background-position: 0 -912px !important; }
.ic_b_tbloptimize { background-position: 0 -928px !important; }
.ic_b_tipp { background-position: 0 -944px !important; }
.ic_b_trigger_add { background-position: 0 -960px !important; }
.ic_b_triggers { background-position: 0 -976px !important; }
.ic_b_undo { background-position: 0 -992px !important; }
.ic_b_unique { background-position: 0 -1008px !important; }
.ic_b_usradd { background-position: 0 -1024px !important; }
.ic_b_usrcheck { background-position: 0 -1040px !important; }
.ic_b_usrdrop { background-position: 0 -1056px !important; }
.ic_b_usredit { background-position: 0 -1072px !important; }
.ic_b_usrlist { background-position: 0 -1088px !important; }
.ic_b_view { background-position: 0 -1104px !important; }
.ic_b_view_add { background-position: 0 -1120px !important; }
.ic_b_views { background-position: 0 -1136px !important; }
.ic_bd_browse { background-position: 0 -1152px !important; }
.ic_bd_deltbl { background-position: 0 -1168px !important; }
.ic_bd_drop { background-position: 0 -1184px !important; }
.ic_bd_edit { background-position: 0 -1200px !important; }
.ic_bd_empty { background-position: 0 -1216px !important; }
.ic_bd_export { background-position: 0 -1232px !important; }
.ic_bd_ftext { background-position: 0 -1248px !important; }
.ic_bd_index { background-position: 0 -1264px !important; }
.ic_bd_insrow { background-position: 0 -1280px !important; }
.ic_bd_nextpage { background-position: 0 -1296px !important; width: 8px; height: 13px; }
.ic_bd_primary { background-position: 0 -1312px !important; }
.ic_bd_sbrowse { background-position: 0 -1328px !important; width: 10px; height: 10px; }
.ic_bd_select { background-position: 0 -1344px !important; }
.ic_bd_spatial { background-position: 0 -1360px !important; }
.ic_bd_unique { background-position: 0 -1376px !important; }
.ic_col_drop { background-position: 0 -1392px !important; }
.ic_eye { background-position: 0 -1408px !important; }
.ic_eye_grey { background-position: 0 -1424px !important; }
.ic_lightbulb { background-position: 0 -1440px !important; }
.ic_lightbulb_off { background-position: 0 -1456px !important; }
.ic_more { background-position: 0 -1472px !important; width: 13px; }
.ic_new_data { background-position: 0 -1488px !important; }
.ic_new_data_hovered { background-position: 0 -1504px !important; }
.ic_new_data_selected { background-position: 0 -1520px !important; }
.ic_new_data_selected_hovered { background-position: 0 -1536px !important; }
.ic_new_struct { background-position: 0 -1552px !important; }
.ic_new_struct_hovered { background-position: 0 -1568px !important; }
.ic_new_struct_selected { background-position: 0 -1584px !important; }
.ic_new_struct_selected_hovered { background-position: 0 -1600px !important; }
.ic_pause { background-position: 0 -1616px !important; }
.ic_play { background-position: 0 -1632px !important; }
.ic_s_asc { background-position: 0 -1648px !important; width: 11px; height: 9px; }
.ic_s_asci { background-position: 0 -1664px !important; }
.ic_s_attention { background-position: 0 -1680px !important; }
.ic_s_cancel { background-position: 0 -1696px !important; }
.ic_s_cog { background-position: 0 -1712px !important; }
.ic_s_db { background-position: 0 -1728px !important; }
.ic_s_desc { background-position: 0 -1744px !important; width: 11px; height: 9px; }
.ic_s_error { background-position: 0 -1760px !important; }
.ic_s_error2 { background-position: 0 -1776px !important; width: 11px; height: 11px; }
.ic_s_host { background-position: 0 -1792px !important; }
.ic_s_info { background-position: 0 -1808px !important; width: 11px; height: 11px; }
.ic_s_lang { background-position: 0 -1824px !important; }
.ic_s_loggoff { background-position: 0 -1840px !important; }
.ic_s_notice { background-position: 0 -1856px !important; }
.ic_s_passwd { background-position: 0 -1872px !important; }
.ic_s_really { background-position: 0 -1888px !important; width: 11px; height: 11px; }
.ic_s_reload { background-position: 0 -1904px !important; }
.ic_s_replication { background-position: 0 -1920px !important; }
.ic_s_rights { background-position: 0 -1936px !important; }
.ic_s_sortable { background-position: 0 -1952px !important; width: 11px; height: 15px; }
.ic_s_status { background-position: 0 -1968px !important; }
.ic_s_success { background-position: 0 -1984px !important; }
.ic_s_sync { background-position: 0 -2000px !important; }
.ic_s_tbl { background-position: 0 -2016px !important; }
.ic_s_theme { background-position: 0 -2032px !important; }
.ic_s_top { background-position: 0 -2048px !important; }
.ic_s_vars { background-position: 0 -2064px !important; }
.ic_s_views { background-position: 0 -2080px !important; width: 10px; height: 10px; }
.ic_window-new { background-position: 0 -2096px !important; }
img.sortableIcon { background-position: 0 -1952px; height: 15px; width: 11px; }
th.headerSortUp img.sortableIcon { background-position: 0 -1648px; height: 9px; width: 11px; }
th.headerSortDown img.sortableIcon { background-position: 0 -1744px; height: 9px; width: 11px; }
